...
if _G.MAPi_Active then
  ...
  hangout_madotsuki = _G.MAPi.hangout_map_add(
    LEVEL_MADO, 
    "Madotsuki's Room",
  ...
  _G.MAPi.hangout_add_entry_sound(hangout_madotsuki, madoenter)
  
  --adds a skybox to the hangout, it will complete a full rotation in 240 seconds
  _G.MAPi.hangout_add_skybox(hangout_madotsuki, {
    skytype = "ico",
    front = madoSkies[1]
  }, 240)
  ...
  _G.MAPi.hangout_add_env_tint(hangout_madotsuki, {r = 255, g = 255, b = 255}, {x = 0, y = 0, z = 0})
  
  --adds a new hangout to mapi
  hangout_poniko = _G.MAPi.hangout_map_add(
    LVL_PONIKO, 
    "Poniko's House",
  ...
  _G.MAPi.hangout_add_skybox(hangout_poniko,
   {
    skytype = "ico",
    front = uboasky
  }, 120)
